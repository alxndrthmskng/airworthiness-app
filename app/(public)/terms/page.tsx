    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-3xl mx-auto px-4 py-16">
        ...
        <div className="prose prose-gray prose-sm max-w-none space-y-6 text-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold text-foreground mt-8 mb-3">2. Eligibility</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-foreground mt-8 mb-3">3. Account Responsibilities</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-foreground mt-8 mb-3">4. Licence Verification</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-foreground mt-8 mb-3">6. Digital Logbook</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-foreground mt-8 mb-3">7. Continuation Training</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-foreground mt-8 mb-3">8. Intellectual Property</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-foreground mt-8 mb-3">10. Account Deletion</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-foreground mt-8 mb-3">11. Termination</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-foreground mt-8 mb-3">13. Changes</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-foreground mt-8 mb-3">14. Contact</h2>
